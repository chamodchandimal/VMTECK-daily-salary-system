...
if(isset($_SESSION['id']) && isset($_SESSION['username'])){
    ...
    .password-form label {
        ...
        width: 150px;  /* This width ensures that the colons align. Adjust as needed. */
        text-align: right;  /* Align the text of the label to the right, so the colon is at the end */
    }

    .password-form input[type="password"] {
        margin-bottom: 10px;  /* Space between each input field */
    }
</style>
        <div align="center">
